...
public class MySkin extends Skin
{
     ...
     * extension exists, it is loaded as a {@link com.badlogic.gdx.graphics.g2d.TextureAtlas} and the texture regions added to the skin. The atlas is
     ...
     * region and stored in the skin. If the region is an {@link com.badlogic.gdx.graphics.g2d.TextureAtlas.AtlasRegion} then the {@link com.badlogic.gdx.graphics.g2d.TextureAtlas.AtlasRegion#splits} are used,
     ...
     * and stored in the skin. If the region is an {@link com.badlogic.gdx.graphics.g2d.TextureAtlas.AtlasRegion} then an {@link com.badlogic.gdx.graphics.g2d.TextureAtlas.AtlasSprite} is used if the region has been
    ...
    /**
     * Returns the {@link com.badlogic.gdx.graphics.g2d.TextureAtlas} that resources in this skin reference, or null.
     */
    ...
    /**
     * Disposes the {@link com.badlogic.gdx.graphics.g2d.TextureAtlas} and all {@link com.badlogic.gdx.utils.Disposable} resources in the skin.
     */
    public void dispose()
    {
        if(atlas != null)
