...
public class ResourceManager implements IResourceLoader, IResourceRetriever
{
     ...
     */
    public String root = "assets/overlap/";
    public String packResolutionName = root + "orig";
    public String scenesPath = root + "scenes";
    public String particleEffectsPath = root + "particles";
    public String spriteAnimationsPath = root + "sprite_animations";
    public String fontsPath = root + "freetypefonts";
    ...
    public void loadFonts()
    {
        ...
        ResolutionEntryVO curResolution = getProjectVO().originalResolution;
    ...
    public ProjectInfoVO loadProjectVO()
    {
        ...
        FileHandle file = Gdx.files.internal(root + "project.dt");
        Json json = new Json();
